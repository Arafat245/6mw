#!/usr/bin/env python3
"""Compare 8 feature selection methods with Demo(4), K=20, inside LOO."""
...
K = 20
alpha = 20
print(f"K={K} accel + Demo(4), Ridge a={alpha}, LOO CV, inside LOO (no leakage)")
print(f"{'Method':<16s}  {'R2':>8s}  {'MAE':>5s}  {'rho':>6s}  {'time':>6s}")
print("-" * 52)
